...
TimeOfDay defaultStartTime = TimeOfDay(hour: 0, minute: 0);
TimeOfDay defaultFinishTime = TimeOfDay(hour: 23, minute: 59);
RangeValues defaultDistance = RangeValues(0, 500);
